      ...
      <div className="md:w-[80%] w-[90%] m-auto md:flex h-full items-center">
        <div className="md:w-1/2">
          ...
          <button
            ...
            className="w-[140px] gap-2 font-semibold h-[40px] hover:text-white flex justify-center items-center bg-white hover:bg-black rounded-md "
          >
            Shop Now <MoveRight />
          </button>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src={
              "https://ik.imagekit.io/t1bpsrjkn/products/pexels-seppe-de-deckers-2155900898-33993031.jpg?updatedAt=1758774492171"
            }
            alt="banner"
            width={450}
            height={450}
