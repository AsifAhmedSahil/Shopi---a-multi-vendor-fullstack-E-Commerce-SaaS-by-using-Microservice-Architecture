...
const Page = () => {
  ...
  //   verify session id with use effect hook
  ...
  useEffect(() => {
    const fetchSessionAndClientSecret = async () => {
      ...
      try {
        ...
        console.error(error);
        setError("Something wnet wrong while preparing your payment.");
      } finally {
        setLoading(false);
      }
    };
  ...
  if (error) {
    return (
      <div className="min-h-[60vh] px-4 flex justify-center items-center">
